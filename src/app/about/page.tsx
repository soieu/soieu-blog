    ...
    <div>
      <div className="flex flex-row items-center justify-center">
        <div className="border border-black mr-2 p-5">
          ...
          <p className="text-lg">
            학습할 때 직접 스터디를 조직하고 이끌고, 서로의 지식을 공유하는
            과정을 중요하게 생각합니다. 저는 다양한 관점을 배우며, 이를 통해
          ...
          <p className="text-lg">
            제가 개발하는 모든 서비스와 기능은 결국 사용자에게 실질적인 가치를
            제공하는 데 목표를 두며 사용자 경험을 최우선으로 고려합니다. 이러한
            믿음은 단순한 기술 구현을 넘어, 사람들과의 연결을 강화하고, 더 나은
            삶을 만들어가는 데 기여할 수 있는 개발을 추구하는 원동력이 되고
